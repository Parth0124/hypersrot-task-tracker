            ...
            <form onSubmit={handleSubmit}>
              <div className="row mb-3">
                ...
                <div className="col-sm-9">
                  <input
                    type="text"
                    name="title"
                    className="form-control border border-secondary-subtle border-2"
                    id="title"
                    value={title}
              ...
              <div className="row mb-3 d-flex flex-row">
                ...
                <div className="col-sm-3">
                  <select
                    className="form-select border border-secondary-subtle border-2"
                    id="priority"
                    name="priority"
                    value={priority}
              ...
              <div className="row d-flex justify-content-end gap-3">
                <button
                  type="button"
                  className="btnColor w-25 border border-0 rounded-1 text-white btn btn-dark"
                  onClick={handleClose}
                >
                  Close
                </button>
