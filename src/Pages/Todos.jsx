...
const Todos = () => {
  ...
  return (
    <div className='container border border-4 rounded-3 shadow p-4 mb-5'>
        ...
        <div className="col-md-12">
          ...
          <div className="searchBar">
            <div className="filterOptions d-flex justify-content-between mb-3">
              <div className="d-lg-flex flex-lg-row d-md-flex flex-md-row gap-4 d-sm-flex flex-sm-col">
                <h6>Filter By: </h6>
                  ...
                  <input type="text" name="assignee" id="assignee" placeholder='Assignee Name' className='border border-0 rounded-2 px-lg-3 mx-sm-3' value={searchQuery} onChange={handleSearchChange}/>
            ...
            <div className="d-flex gap-4 align-items-center">
              <h6>Sort By: </h6>
              <select name='priority' id='priority' className='outline-0 border border-0 rounded-2 px-3 text-secondary' value={priorityFilter} onChange={handlePriorityFilterChange}>
                <option selected value="all">Priority</option>                    
                <option value="P0">P0</option>
                <option value="P1">P1</option>
                <option value="P2">P2</option>
      ...
      <div className="row">
        <div className="col-md-12">
          <DisplayTodos searchQuery={searchQuery} priorityFilter={priorityFilter} dateRangeFilter={dateRangeFilter}/>
        </div>
      </div>

      {/* AddTask Component */}
      <div className="row">
        <div className="d-block d-sm-block d-xs-block d-md-block d-none d-lg-none w-50 m-auto mt-5"> {/* This ensures the button takes full width on small screens */}
          <button type='button' className='btnColor rounded-1 border border-0 text-white fw-semibold px-5 py-sm-1 w-100' onClick={handleAddTask}>
            Add New Task
          </button>
        </div>
      </div>
